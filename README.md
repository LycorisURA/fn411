...
| EX | Exam prep | A four-question mock in the exam's format (long multi-step questions, every step worked, every number re-solved in the Excel solver), the timed self-marking quiz mock, and a one-page formula sheet |
...
| <kbd>T</kbd> <kbd>C</kbd> <kbd>?</kbd> | Theme · companion chat · the shortcut list |

The companion, Kasumi, and her chat are **hidden by default**. The **☺ Kasumi** button in the
masthead (or <kbd>C</kbd>) brings her in, and the choice is remembered.
