...
PARTS = [
    ...
    "02h-formulas.html", # Tail FX formulas & functions (generated by excel/generator/formula_bank.py)
    ...
    "06c-search.js",   # full-text search (Ctrl+K, /) and the question finder on the GO panel
    "07-boot.html",    # boot()
]
